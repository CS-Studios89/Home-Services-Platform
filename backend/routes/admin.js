...
router.get('/service-categories', adminController.listServices);
router.post('/service-categories', adminController.createService);
router.patch('/service-categories/:categoryId', adminController.updateService);
router.delete('/service-categories/:categoryId', adminController.deleteService);
